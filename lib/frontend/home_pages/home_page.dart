...
// Single Category tile
              ...
              Row(
                children: [
                  ...
                  IconButton(
                    icon: Icon(Icons.add, size: 22, color: Colors.black54),
                    onPressed: () {
                      _showAddScheduledPaymentDialog();
                    },
                  ),
                  IconButton(
                    icon: Icon(
                      showAllScheduledPayments ? Icons.expand_less : Icons.expand_more,
                      size: 22,
                      color: Colors.black54,
                    ),
                    onPressed: () {
  ...
  void _showAddScheduledPaymentDialog() {
    ...
    String? selectedMerchant = merchantNames.isNotEmpty ? merchantNames.first : null;
          ...
          builder: (context, setState) {
            return AlertDialog(
              ...
              actions: [
                ...
                TextButton(
                  onPressed: () {
                    print("Scheduled Payment: Merchant: $selectedMerchant, Amount: $recurringAmount, Date: ${startDate != null ? DateFormat('yyyy-MM-dd').format(startDate!) : 'N/A'}, Time: ${startTime != null ? startTime!.format(context) : 'N/A'}, Period: $selectedPeriod");
                    Navigator.pop(context);
                  },
                  child: Text("Add"),
                ),
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => ScheduledPaymentDetailPage(
              payment: schedModel.ScheduledPayment(
...
class ScheduledPayment {
  ...
  String get merchant => name;
  double get recurringAmount => amount;
  DateTime get startDate => DateTime.now();
  String get recurringPeriod => "Monthly";
}
